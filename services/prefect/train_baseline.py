...
def main():
    ...
    # TODO 2: liste des features Feast (14)
    features = [
    ...
    with mlflow.start_run(run_name=f"rf_baseline_{AS_OF}") as run:
        ...
        # TODO 9: log_model -> on logge la PIPELINE complète (prep + modèle)
        ...
        print(f"[INFO] Training rows after merge: {len(df)}")
        print(f"[INFO] cat_cols={cat_cols}")
        print(f"[INFO] num_cols={num_cols}")
